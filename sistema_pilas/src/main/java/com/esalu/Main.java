      ...
      switch(opcion){
        ...
        case 2:
          ...
          if(expresionPostfija!= null){
            System.out.println("Ya hay una expresión postfija guardada en memoria.");
            break;
          }
        ...
        case 3:
          ...
          if(expresionPrefija!= null){
            System.out.println("Ya hay una expresión prefija guardada en memoria.");
            break;
          }
        ...
        case 4:
          ...
          System.out.println("\nLa expresión postfija es: " + expresionPostfija+"\nEl resultado es: " + ExpressionConverter.evaluatePostfixExpression(expresionPostfija, values, operadores));
